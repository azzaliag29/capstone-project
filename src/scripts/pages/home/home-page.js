...
export default function renderHomePage() {
  ...
  <section class="home-page"> 
      ...
      <img src="./images/iconic-quibly.png" alt="Quibly App Icon" class="about-image-img">
        ...
        <p> 
            ...
            By using intelligent text processing technology, Quibly allows you to transform text or documents into shorter, more concise, 
            and easier-to-understand summaries.In addition to summarizing, Quibly also automatically extracts important keywords from the 
            content of the document. These keywords not only help in understanding the core of the reading but can also be used to explore 
            further references directly on Google Scholar — making it very suitable for students, researchers, or anyone who wants to read 
  ...
  <div class="testimonials">
    <p class="v123">What they say about us</p>
  </div>
